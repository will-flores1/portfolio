		...
		<div className="shadow-sm bg-white/30 sticky top-0 backdrop-blur-md">
			<div className="flex justify-between p-4 lg:py-2 max-w-2xl lg:max-w-3xl mx-auto">
				<div className="flex px-2 items-center">
					<img
						className="h-6 lg:h-5 hover:cursor-pointer hover:rotate-12 transition ease-in-out duration-300"
						src={props.theme === "dark" ? darkPaw : paw}
						alt=""
					/>
					<div className="text-xl lg:text-lg font-semibold hover:cursor-pointer dark:text-white">
						Wilfredo Flores
					</div>
				</div>
